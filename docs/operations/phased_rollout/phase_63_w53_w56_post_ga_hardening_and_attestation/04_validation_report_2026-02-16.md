...
2. `py -3 scripts/release_gate_check.py`
3. `py -3 scripts/build_release_gate_packet.py`
4. `py -3 scripts/verify_release_gate_packet.py`
5. `py -3 scripts/sign_release_gate_packet.py`
6. `py -3 scripts/verify_release_gate_packet_signature.py`
7. `py -3 scripts/run_ga_replay_matrix.py`
8. `py -3 scripts/check_milestone_archive.py`
9. `py -3 scripts/ci_checks.py`
